...
export const LinkedinIcon = ({ size = 20, className = "", ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
// Official X (formerly Twitter) Logo Path
export const XIcon = ({ size = 20, className = "", ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
...
// Custom Mail Envelope Icon Path
